...
router.get(`/stream/:streamer`, async (req, res) => {
    ...
    const getStreamVideo = await axios.get(`http://localhost:8951/api/streams/live/${getStreamKey.streamkey}`, { auth: { username: `admin`, password: process.env.RTMP_API_PASSWORD } });
